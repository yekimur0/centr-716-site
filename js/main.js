...
const reviews_swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.reviews__swiper', {
  navigation: {
...
const listener = () => {
  document.body.addEventListener('click', e => {
    ...
    if (target.dataset.button === 'consult') openModal(target);
  ...
  function showSubMenuFooter(target) {
    const parent = target.closest('.footer__services');
    const menu = parent.querySelector('.footer__services-items');
